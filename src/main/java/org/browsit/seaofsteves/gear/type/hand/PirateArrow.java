...
public class PirateArrow implements PirateGear {
    private static final Material material = Material.ARROW;
    private static final String display = ItemUtil.getGearDisplay(PirateArrow.class);
    private static final List<String> lore = ItemUtil.getGearLore(PirateArrow.class);
