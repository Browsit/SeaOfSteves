...
public class PirateLongbow implements PirateGear {
    private static final Material material = Material.BOW;
    private static final String display = ItemUtil.getGearDisplay(PirateLongbow.class);
    private static final List<String> lore = ItemUtil.getGearLore(PirateLongbow.class);
