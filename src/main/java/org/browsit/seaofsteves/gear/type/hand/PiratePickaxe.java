...
public class PiratePickaxe implements PirateGear {
    private static final Material material = Material.IRON_PICKAXE;
    private static final String display = ItemUtil.getGearDisplay(PiratePickaxe.class);
    private static final List<String> lore = ItemUtil.getGearLore(PiratePickaxe.class);
