...
public class PirateSabre implements PirateGear {
    private static final Material material = Material.IRON_SWORD;
    private static final String display = ItemUtil.getGearDisplay(PirateSabre.class);
    private static final List<String> lore = ItemUtil.getGearLore(PirateSabre.class);
