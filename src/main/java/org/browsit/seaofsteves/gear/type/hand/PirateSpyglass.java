...
public class PirateSpyglass implements PirateGear {
    private static final Material material = Material.SPYGLASS;
    private static final String display = ItemUtil.getGearDisplay(PirateSpyglass.class);
    private static final List<String> lore = ItemUtil.getGearLore(PirateSpyglass.class);
